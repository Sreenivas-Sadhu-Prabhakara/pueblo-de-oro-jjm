...
const highlights: { icon: React.FC<{className?: string; size?: number}>; title: string; desc: string }[] = [
  ...
  { icon: IconLocation, title: 'Prime Location',      desc: 'Near schools, hospitals, shopping centers & highways' },
  { icon: IconBusiness, title: 'Trusted Developer',   desc: 'Licensed developer with 20+ years of real estate experience' },
  { icon: IconPayment,  title: 'Flexible Payment',    desc: 'Pag-IBIG financing up to 20 years at competitive rates' },
  { icon: IconApartment,title: 'Modern Community',    desc: 'Clubhouse, swimming pool, playground & landscaped gardens' },
  { icon: IconTrending, title: 'Appreciating Asset',  desc: 'Rapidly developing area with strong property value growth' },
]
      ...
      <div className="section-inner">
            ...
            return (
              <div key={h.title} className="card group cursor-default">
                <div className="w-11 h-11 rounded-xl bg-primary-100 dark:bg-primary-950/50 flex items-center justify-center mb-4
                  ...
                  <Ico size={22} className="text-primary-600 dark:text-primary-400" />
                </div>
        ...
        <div className="relative bg-white dark:bg-surface-dark rounded-2xl p-8 sm:p-10 shadow-card border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-6 flex items-center gap-2">
            <IconStar size={22} className="text-primary-500" />
